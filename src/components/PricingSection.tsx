...
const features = [
  ...
  { icon: BarChart3, text: "Ranking visual com 5 estilos diferentes" },
  { icon: Layers, text: "Criacao de squads com cores personalizadas" },
  { icon: Target, text: "Metas de vendas, entrada, calls e leads" },
  { icon: PartyPopper, text: "Celebracoes automaticas com confetes" },
  { icon: Palette, text: "Personalizacao de cores, logo e favicon" },
  { icon: FileSpreadsheet, text: "Exportacao de relatorios em CSV" },
  { icon: HeadphonesIcon, text: "Suporte prioritario incluido" },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold font-display mb-6 text-foreground">
            Um Unico Plano,{" "}
            <span className="text-gradient">Tudo Incluido</span>
          </h2>
        ...
        <div className="max-w-xl mx-auto">
          <div className="glass-strong rounded-3xl p-8 md:p-12 glow-primary relative overflow-hidden">
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              7 dias de garantia - Suporte incluido - Sem limite de vendedores
            </p>
          </div>
